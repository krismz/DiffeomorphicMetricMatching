...
#from util.tensors import make_tens_interpolators, batch_interpolate_3d
...
# Tried following but much less efficient than other interp methods
# def batch_get_gamma_ddot_from_interp_at_point_3d(x, y, z, Gamma_interps, gamma_dot):
#   tens = batch_interpolate_3d(x,y,z,Gamma_interps)
#   Gamma11 = tens[:,0,0]
#   Gamma12 = tens[:,0,1]
#   Gamma13 = tens[:,0,2]
#   Gamma22 = tens[:,1,1]
...
def batch_geodesicpath_3d(tensor_field, mask_image, start_coordinates, initial_velocities, delta_t=0.15, iter_num=18000,
  ...
  if ( (Gamma1 is None) or (Gamma2 is None) or (Gamma3 is None) ):
    Gamma1, Gamma2, Gamma3 = compute_gammas_3d(tensor_field, mask_image)
    #Gamma1 = make_tens_interpolators(Gamma1tens)
    #Gamma2 = make_tens_interpolators(Gamma2tens)
    #Gamma3 = make_tens_interpolators(Gamma3tens)
